...
public class RcaUtilityDao {
	...
	public static String saveRcaDetails(RCA rca)
	{
	    ...
	    try
	    {
	    	...
	    	String sql = "INSERT INTO rca_count(mr_product_backlog, mr_qa, mr_uat, mr_prod, cr_product_backlog, cr_qa, cr_uat, cr_prod," +
	    			...
	    			"ffm_product_backlog, ffm_qa, ffm_uat, ffm_prod, crmesb_product_backlog, crmesb_qa, crmesb_uat, crmesb_prod, otp_product_backlog, otp_qa, otp_uat, otp_prod, pmuu_product_backlog, pmuu_qa, pmuu_uat, pmuu_prod, io_product_backlog, io_qa, io_uat, io_prod, overview_message, risks_issues, week,project_id) values (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?," +
	    			" ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
	...
	private static void setRcaFields(RCA rca,PreparedStatement stmt)
	{
		try {
	    	...
	    	stmt.setString(98, rca.week);
	    	stmt.setInt(99, rca.project_id);
